...
var tableName = "com.bsafes.teamMembersV2";
...
function indexItem(teamMember, done) {
	if(teamMember.status === "deleted") {
		console.log("This team member was deleted.");
		number ++;
		done(null);
		return;
	}
  ...
  client.index({
    ...
    console.log("number:", number);
		...
		number ++;
    console.log("number:", number);
		console.log("Could not index teamMember", error);
		done(error);
  });
}
